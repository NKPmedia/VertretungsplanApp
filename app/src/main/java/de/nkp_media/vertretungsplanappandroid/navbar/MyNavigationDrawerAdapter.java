...
public class MyNavigationDrawerAdapter extends RecyclerView.Adapter<MyNavigationDrawerAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView,int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                Klasse = (TextView) itemView.findViewById(R.id.selectedKlasseText);
    ...
    MyNavigationDrawerAdapter(String Titles[], int Icons[], String Name, String Email, int Profile, MainActivity parentActivity){ // MyAdapter Constructor with titles and icons parameter
    ...
    @Override
    public MyNavigationDrawerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
